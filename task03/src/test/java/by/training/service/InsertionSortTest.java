...
import by.training.task03.service.impl.InsertionSort;
...
public class InsertionSortTest {
    ...
    public void testSortIncreasing(Array<Double> arr, Array<Double> expArr) {
        Array<Double> actualArray = insertionSort.sortIncreasing(arr);
    ...
    public void testSortDecreasing(Array<Double> arr, Array<Double> expArr) {
        Array<Double> actualArray = insertionSort.sortDecreasing(arr);
        assertEquals(actualArray, expArr);
    }
}