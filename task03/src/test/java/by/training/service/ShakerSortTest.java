...
import by.training.task03.service.impl.ShakerSort;
...
public class ShakerSortTest {
    ...
    public void testSortIncreasing(Array<Double> arr, Array<Double> expArr) {
        Array<Double> actualArray = shakerSort.sortIncreasing(arr);
    ...
    public void testSortDecreasing(Array<Double> arr, Array<Double> expArr) {
        Array<Double> actualArray =  shakerSort.sortDecreasing(arr);
        assertEquals(actualArray, expArr);
    }
}