...
public class DissectionBall implements Command {
    private final ServiceFactory serviceFactory = ServiceFactory.getInstance();
    private static final Logger logger = LogManager.getLogger(DissectionBall.class);
    ...
    public Object executeCommand(String idObject, String fileName) {
        ...
        try {
            ...
            Dissection dissection = serviceFactory.getDissection();
            return dissection.findVolumeRatio(resultBall);
