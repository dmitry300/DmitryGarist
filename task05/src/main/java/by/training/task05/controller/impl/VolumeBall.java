...
public class VolumeBall implements Command {
    private final ServiceFactory serviceFactory = ServiceFactory.getInstance();
    private static final Logger logger = LogManager.getLogger(VolumeBall.class);
    ...
    public Object executeCommand(String idObject, String fileName) {
        ...
        try {
            ...
            Volume volume = serviceFactory.getVolume();
            return volume.findVolume(resultBall);
