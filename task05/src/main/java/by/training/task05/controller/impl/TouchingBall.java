...
public class TouchingBall implements Command {
    private final ServiceFactory serviceFactory = ServiceFactory.getInstance();
    private static final Logger logger = LogManager.getLogger(TouchingBall.class);
    ...
    public Object executeCommand(String idObject, String fileName) {
        ...
        try {
            ...
            Touching touching = serviceFactory.getTouching();
            return touching.isTouching(resultBall);
