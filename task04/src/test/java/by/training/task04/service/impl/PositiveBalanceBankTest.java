...
public class PositiveBalanceBankTest {
    PositiveBalanceBank positiveBalanceBank = new PositiveBalanceBank();

    @Test(description = "Positive scenario for calculating positive sum accounts")
    public void testFindTotalBalanceClient() {
        ...
        int actual = positiveBalanceBank.findTotalBalanceClient(bank);
        int expected = 125;
