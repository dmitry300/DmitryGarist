        ...
        <div class="d-flex flex-column justify-content-center align-items-center">
            ...
            <c:if test="${not empty requestScope.review}">
                ...
                <div class="review d-flex w-75 flex-column mt-4 mb-4 p-4">
                    <div class="d-flex justify-content-between align-items-center" id="review">
                    ...
                    <div class="d-flex justify-content-between">
                        <form action="controller" method="post">
                            ...
                            <label>
                            <textarea class="review-text display-1 fs-2 mb-2" name="content"
                                      rows="3">${review.comment}</textarea>
                            </label>
<%--                            <input class="review-text display-1 fs-2 mb-2" name="content" value="${review.comment}">--%>
                            <button type="submit" class="btn btn-outline-success w-25"><fmt:message
                                    key="admin.review.edit"
                                    bundle="${rb}"/></button>
                        </form>
                    </div>
                </div>
